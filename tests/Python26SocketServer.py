...
class BaseServer:
    ...
    def __init__(self, server_address, RequestHandlerClass):  # noqa
    ...
    def _handle_request_noblock(self):
        ...
        """
        try:
            request, client_address = self.get_request()  # noqa
        except socket.error:
            return
    ...
    def verify_request(self, request, client_address):  # noqa
    ...
    @staticmethod
    def handle_error(request, client_address):  # noqa
